...
public class Word extends SugarRecord<Word> implements Parcelable {
    ...
    public Word(String eng, String lemma, String syllable1, String syllable2) {
        this.eng = eng;
        this.lemma = lemma;
    ...
    @Override
    public int hashCode() {
        int result = eng != null ? eng.hashCode() : 0;
